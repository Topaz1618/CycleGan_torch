...
for idx, img in enumerate(data['x_train']):
    if idx < 1600:
        ...
        cv2.imwrite(f"/Users/topaz/Projects/py_cyclegan/data/mnist/trainA/{idx}.png", img)

    elif idx >= 1600 and idx < 2000:
        img = change_numeral(img)
        cv2.imwrite(f"/Users/topaz/Projects/py_cyclegan/data/mnist/testA/{idx}.png", img)
